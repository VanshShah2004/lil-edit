...
import { BarChart3, ChevronDown, ClipboardList, LayoutDashboard, LayoutGrid, Plus, Settings, Shirt } from "lucide-react";
...
const TABS = [
  ...
  { to: "/admin/analytics", label: "Analytics", icon: BarChart3, section: "Business Intelligence" },
