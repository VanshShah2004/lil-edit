    ...
    <section className="relative overflow-hidden rounded-b-[2rem] md:rounded-b-[2.5rem]">
      <div className="container mx-auto px-4 lg:px-8 py-2 lg:py-2 pb-8 lg:pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-6 items-center">
          {/* Text */}
          <div className="flex flex-col gap-2 animate-fade-in-up text-center lg:text-left">
            <span className="text-[11px] sm:text-xs md:text-sm font-body uppercase tracking-[0.2em] md:tracking-[0.25em] text-primary/90 font-medium">
              New Collection 2026
            </span>
            ...
            <p className="text-muted-foreground font-body text-sm sm:text-base max-w-md lg:max-w-lg leading-relaxed mx-auto lg:mx-0">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 justify-center lg:justify-start">
              <Link to="/shop">
                <Button
                  size="lg"
                  className={`font-body rounded-full w-full sm:w-auto px-6 sm:px-8 gap-2 transition-all duration-300 border-2 ${isExploreHovered
              ...
              >
                <Button
                  size="lg"
                  className={`font-body rounded-full w-full sm:w-auto px-6 sm:px-8 transition-all duration-300 border-2 ${isExploreHovered
