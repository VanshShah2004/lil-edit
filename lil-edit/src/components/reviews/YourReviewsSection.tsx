                  ...
                  <div className="shrink-0">
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-sm font-medium transition-colors ${
                        isReviewed
                          ? "text-brand-teal border border-brand-teal/30 bg-brand-teal/5 hover:bg-brand-teal/10"
                          : "text-white bg-brand-teal hover:bg-brand-teal/90"
                      }`}
                    >
                      {isOpen ? "Close" : isReviewed ? "Edit Review" : "Write Review"}
                    </button>
                  </div>
                </div>
