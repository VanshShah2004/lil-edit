  ...
  useEffect(() => {
    const loadProduct = async () => {
      ...
      try {
        ...
        const allProducts = [...(data.published || []), ...(data.drafts || [])];
        ...
        setFormData({
          ...
          selectedColors: (variants || []).map((v: any) => ({
            ...
            isUnlimited: Number(v.stock ?? 0) >= 99999,
        ...
        <div className="mx-auto max-w-none">
          ...
          >
            <button
              ...
              className="flex items-center gap-2 text-sm font-bold text-gray-600 hover:text-gray-900 transition-colors mb-4"
            >
                    ...
                    <motion.div whileHover={{ scale: 1.01 }} className="group">
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full px-5 py-4 rounded-md border border-gray-200 bg-[#F5F4F6] text-gray-400 cursor-not-allowed outline-none transition-all duration-300 font-mono text-[13px] tracking-wider`}
                        />
                        {formData.sku && (
